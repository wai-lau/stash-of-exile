...
# Archetype tagging (tags_for, subject_for, minion_subtype) lives in
# sox.valuation.tagging, shared with the runtime so a mod resolved
# from the live table is tagged exactly as the allowlist is.
