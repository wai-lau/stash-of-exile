...
| Waystones | the tier's bulk exchange book — a stone's search caps at 10,000 matches, a commodity. A stone worth running (loot 70 up) is run, not sold, and not searched; one under that with a single total at its market cliff is searched to sell, on that total; a Tier 16 is always searched, its book being bait. What the market pays, measured: [docs/waystones.md](docs/waystones.md) |
